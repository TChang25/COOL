...
***The system avoids tracking personally identifiable information and storing sensitive data for demonstration purposes. All users represented in the seed data and otherwise throughout this document are not depictions of real people nor do they attempt to represent real locations. The developers in their best attempts will store secrets, keys, and other sensitive data aligned with industry best pratices.***
...
This part is not required for the project to run, however creates a live site to view all the documents laid thereout in this .pdf

### Navigate to Documentation in WSL
```bash
$ cd /documentation
```
...
### Build to get .pdf / web server files
pdf is located in documentation/site/pdf
